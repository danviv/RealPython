...
db.project.start_date.requires = IS_DATE(format=T('%d-%m-%Y'),error_message='Must be DD-MM-YYYY!')
db.project.due_date.requires = IS_DATE(format=T('%d-%m-%Y'),error_message='Must be DD-MM-YYYY!')
...
db.note.created_on.requires = IS_DATE(format=T('%d-%m-%Y'),error_message='Must be DD-MM-YYYY!')
